...
<aside class="w-64 bg-orange-400 min-h-screen text-white fixed top-0 left-0 shadow-lg flex flex-col">
    ...
    <nav class="mt-1 flex-grow">
        <ul>
            ...
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-users mr-3"></i> <a href="../admin/daftar_pengguna.php">Pengguna</a>
            </li>
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-virus mr-3"></i> <a href="../admin/penyakit.php">Penyakit</a>
            </li>
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-stethoscope mr-3"></i> <a href="../admin/gejala.php">Gejala</a>
            </li>
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-link mr-3"></i> <a href="../admin/relasi.php">Relasi</a>
            </li>
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-chart-line mr-3"></i> <a href="../admin/cf_user.php">CF User</a>
            </li>
            <li class="hover:bg-orange-500 transition duration-300 flex items-center px-6 py-3 rounded-lg">
                <i class="fas fa-folder-open mr-3"></i> <a href="../admin/rekam_medis.php">Rekam Medis</a>
            </li>
        </ul>
    </nav>
